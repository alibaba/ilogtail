...
#        -t sls-opensource-registry.cn-shanghai.cr.aliyuncs.com/ilogtail-community-edition/ilogtail-build-linux:2.0.4 \
#        -o type=registry \
#        --no-cache -f Dockerfile.ilogtail-build-linux .

#curl -L https://github.com/regclient/regclient/releases/latest/download/regctl-linux-amd64 >regctl

regctl image copy sls-opensource-registry.cn-shanghai.cr.aliyuncs.com/ilogtail-community-edition/ilogtail-build-linux:2.0.4 \
        sls-opensource-registry.cn-shanghai.cr.aliyuncs.com/ilogtail-community-edition/ilogtail-build-linux:2.0.4
