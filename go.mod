...
require (
	...
	github.com/volcengine/volc-sdk-golang v1.0.146 // indirect
...
require (
	code.byted.org/aiops/oneagent-volc-plugins v0.0.16
	code.byted.org/iaasng/oneagent-ecs-plugins v0.0.0-20240911093327-0d0e2058306f
)
