...
func TestConvertOtlpLogV1(t *testing.T) {
	...
	decoder := &Decoder{Format: common.ProtocolOTLPLogV1}
	result, err := decoder.ConvertOtlpLogV1(otlpLogReq)
	if err != nil {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			case pmetric.MetricTypeGauge:
				...
				assert.Equal(t, "bool#$#true|bytes#$#Zm9v|double#$#1.1|exemplar_0_spanID#$#1112131415161718|exemplar_0_traceID#$#1112131415161718|host_name#$#testHost|int#$#1|service_name#$#testService|string#$#value", logs[0].Contents[1].Value)
			...
			case pmetric.MetricTypeSum:
				...
				assert.Equal(t, "__labels__", logs[0].Contents[1].Key)
				assert.Equal(t, "bool#$#true|bytes#$#Zm9v|double#$#1.1|exemplar_0_spanID#$#1112131415161718|exemplar_0_traceID#$#1112131415161718|host_name#$#testHost|int#$#1|otlp_metric_aggregation_temporality#$#Cumulative|otlp_metric_ismonotonic#$#true|service_name#$#testService|string#$#value", logs[0].Contents[1].Value)
				assert.Equal(t, "__time_nano__", logs[0].Contents[2].Key)
				assert.Equal(t, "__value__", logs[0].Contents[3].Key)
			...
			case pmetric.MetricTypeHistogram:
				...
				assert.Equal(t, "__labels__", logs[0].Contents[1].Key)
				assert.Equal(t, "bool#$#true|bytes#$#Zm9v|double#$#1.1|exemplar_0_spanID#$#1112131415161718|exemplar_0_traceID#$#1112131415161718|host_name#$#testHost|int#$#1|otlp_metric_aggregation_temporality#$#Cumulative|otlp_metric_histogram_type#$#Histogram|service_name#$#testService|string#$#value", logs[0].Contents[1].Value)
				assert.Equal(t, "__time_nano__", logs[0].Contents[2].Key)
				assert.Equal(t, "__value__", logs[0].Contents[3].Key)
				...
				assert.Equal(t, "__labels__", logs[1].Contents[1].Key)
				assert.Equal(t, "bool#$#true|bytes#$#Zm9v|double#$#1.1|exemplar_0_spanID#$#1112131415161718|exemplar_0_traceID#$#1112131415161718|host_name#$#testHost|int#$#1|otlp_metric_aggregation_temporality#$#Cumulative|otlp_metric_histogram_type#$#Histogram|service_name#$#testService|string#$#value", logs[1].Contents[1].Value)
				assert.Equal(t, "__time_nano__", logs[1].Contents[2].Key)
				assert.Equal(t, "__value__", logs[1].Contents[3].Key)
				...
				assert.Equal(t, "__labels__", logs[2].Contents[1].Key)
				assert.Equal(t, "bool#$#true|bytes#$#Zm9v|double#$#1.1|exemplar_0_spanID#$#1112131415161718|exemplar_0_traceID#$#1112131415161718|host_name#$#testHost|int#$#1|otlp_metric_aggregation_temporality#$#Cumulative|otlp_metric_histogram_type#$#Histogram|service_name#$#testService|string#$#value", logs[2].Contents[1].Value)
				assert.Equal(t, "__time_nano__", logs[2].Contents[2].Key)
				assert.Equal(t, "__value__", logs[2].Contents[3].Key)
				...
				assert.Equal(t, "bool#$#true|bytes#$#Zm9v|double#$#1.1|exemplar_0_spanID#$#1112131415161718|exemplar_0_traceID#$#1112131415161718|host_name#$#testHost|int#$#1|otlp_metric_aggregation_temporality#$#Cumulative|otlp_metric_histogram_type#$#Histogram|service_name#$#testService|string#$#value", logs[3].Contents[1].Value)
				...
				assert.Equal(t, "bool#$#true|bytes#$#Zm9v|double#$#1.1|exemplar_0_spanID#$#1112131415161718|exemplar_0_traceID#$#1112131415161718|host_name#$#testHost|int#$#1|le#$#10|otlp_metric_aggregation_temporality#$#Cumulative|otlp_metric_histogram_type#$#Histogram|service_name#$#testService|string#$#value", logs[4].Contents[1].Value)
				...
				assert.Equal(t, "bool#$#true|bytes#$#Zm9v|double#$#1.1|exemplar_0_spanID#$#1112131415161718|exemplar_0_traceID#$#1112131415161718|host_name#$#testHost|int#$#1|le#$#100|otlp_metric_aggregation_temporality#$#Cumulative|otlp_metric_histogram_type#$#Histogram|service_name#$#testService|string#$#value", logs[5].Contents[1].Value)
				...
				assert.Equal(t, "bool#$#true|bytes#$#Zm9v|double#$#1.1|exemplar_0_spanID#$#1112131415161718|exemplar_0_traceID#$#1112131415161718|host_name#$#testHost|int#$#1|le#$#+Inf|otlp_metric_aggregation_temporality#$#Cumulative|otlp_metric_histogram_type#$#Histogram|service_name#$#testService|string#$#value", logs[6].Contents[1].Value)
			...
			case pmetric.MetricTypeExponentialHistogram:
				...
				assert.Equal(t, "__labels__", logs[0].Contents[1].Key)
				assert.Equal(t, "bool#$#true|bytes#$#Zm9v|double#$#1.1|exemplar_0_spanID#$#1112131415161718|exemplar_0_traceID#$#1112131415161718|host_name#$#testHost|int#$#1|otlp_metric_aggregation_temporality#$#Cumulative|otlp_metric_histogram_type#$#ExponentialHistogram|service_name#$#testService|string#$#value", logs[0].Contents[1].Value)
				assert.Equal(t, "__time_nano__", logs[0].Contents[2].Key)
				assert.Equal(t, "__value__", logs[0].Contents[3].Key)
				...
				assert.Equal(t, "__labels__", logs[1].Contents[1].Key)
				assert.Equal(t, "bool#$#true|bytes#$#Zm9v|double#$#1.1|exemplar_0_spanID#$#1112131415161718|exemplar_0_traceID#$#1112131415161718|host_name#$#testHost|int#$#1|otlp_metric_aggregation_temporality#$#Cumulative|otlp_metric_histogram_type#$#ExponentialHistogram|service_name#$#testService|string#$#value", logs[1].Contents[1].Value)
				assert.Equal(t, "__time_nano__", logs[1].Contents[2].Key)
				assert.Equal(t, "__value__", logs[1].Contents[3].Key)
				...
				assert.Equal(t, "__labels__", logs[2].Contents[1].Key)
				assert.Equal(t, "bool#$#true|bytes#$#Zm9v|double#$#1.1|exemplar_0_spanID#$#1112131415161718|exemplar_0_traceID#$#1112131415161718|host_name#$#testHost|int#$#1|otlp_metric_aggregation_temporality#$#Cumulative|otlp_metric_histogram_type#$#ExponentialHistogram|service_name#$#testService|string#$#value", logs[2].Contents[1].Value)
				assert.Equal(t, "__time_nano__", logs[2].Contents[2].Key)
				assert.Equal(t, "__value__", logs[2].Contents[3].Key)
				...
				assert.Equal(t, "__labels__", logs[3].Contents[1].Key)
				assert.Equal(t, "bool#$#true|bytes#$#Zm9v|double#$#1.1|exemplar_0_spanID#$#1112131415161718|exemplar_0_traceID#$#1112131415161718|host_name#$#testHost|int#$#1|otlp_metric_aggregation_temporality#$#Cumulative|otlp_metric_histogram_type#$#ExponentialHistogram|service_name#$#testService|string#$#value", logs[3].Contents[1].Value)
				assert.Equal(t, "__time_nano__", logs[3].Contents[2].Key)
				assert.Equal(t, "__value__", logs[3].Contents[3].Key)
