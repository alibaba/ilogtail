...
func (m *LogEvent_Content) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
func (m *PipelineEventGroup) GetMetadata() map[string]string {
	if m != nil {
		return m.Metadata
	}
	return nil
...
func (m *PipelineEventGroup) GetTags() map[string]string {
	if m != nil {
		return m.Tags
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "sls_logs.PipelineEventGroup.MetadataEntry")
	proto.RegisterMapType((map[string]string)(nil), "sls_logs.PipelineEventGroup.TagsEntry")
}
...
var fileDescriptor_c58a16dc71f415c6 = []byte{
	...
	0x10, 0xd6, 0x92, 0xd4, 0x0f, 0x47, 0xb1, 0x4d, 0x6c, 0xdb, 0x60, 0x21, 0x24, 0x8a, 0x20, 0xb4,
	...
	,
}
