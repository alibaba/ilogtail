...
var K8sStatefulSetFlag = flag.Bool("ALICLOUD_LOG_K8S_STATEFULSET_FLAG", false, "alibaba log k8s statefulset mode flag, set true if you want to use it")
...
func init() {
	...
	_ = util.InitFromEnvBool("ALICLOUD_LOG_K8S_STATEFULSET_FLAG", K8sStatefulSetFlag, *K8sStatefulSetFlag)
