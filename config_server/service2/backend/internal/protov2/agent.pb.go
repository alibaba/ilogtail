...
type ConfigInfo struct {
	...
	Status  ConfigStatus `protobuf:"varint,3,opt,name=status,proto3,enum=config_server.protov2.v2.ConfigStatus" json:"status,omitempty"` // Config's status
...
type CommandInfo struct {
	...
	Status  ConfigStatus `protobuf:"varint,3,opt,name=status,proto3,enum=config_server.protov2.v2.ConfigStatus" json:"status,omitempty"` // Command's status
	Message string       `protobuf:"bytes,4,opt,name=message,proto3" json:"message,omitempty"`                                           // Optional error message
}
...
var file_agent_proto_goTypes = []any{
	(ConfigStatus)(0),           // 0: config_server.protov2.v2.ConfigStatus
	(AgentCapabilities)(0),      // 1: config_server.protov2.v2.AgentCapabilities
	(RequestFlags)(0),           // 2: config_server.protov2.v2.RequestFlags
	(ServerCapabilities)(0),     // 3: config_server.protov2.v2.ServerCapabilities
	(ResponseFlags)(0),          // 4: config_server.protov2.v2.ResponseFlags
	(*AgentGroupTag)(nil),       // 5: config_server.protov2.v2.AgentGroupTag
	(*ConfigInfo)(nil),          // 6: config_server.protov2.v2.ConfigInfo
	(*CommandInfo)(nil),         // 7: config_server.protov2.v2.CommandInfo
	(*AgentAttributes)(nil),     // 8: config_server.protov2.v2.AgentAttributes
	(*HeartbeatRequest)(nil),    // 9: config_server.protov2.v2.HeartbeatRequest
	(*ConfigDetail)(nil),        // 10: config_server.protov2.v2.ConfigDetail
	(*CommandDetail)(nil),       // 11: config_server.protov2.v2.CommandDetail
	(*HeartbeatResponse)(nil),   // 12: config_server.protov2.v2.HeartbeatResponse
	(*FetchConfigRequest)(nil),  // 13: config_server.protov2.v2.FetchConfigRequest
	(*FetchConfigResponse)(nil), // 14: config_server.protov2.v2.FetchConfigResponse
	(*CommonResponse)(nil),      // 15: config_server.protov2.v2.CommonResponse
	nil,                         // 16: config_server.protov2.v2.AgentAttributes.ExtrasEntry
}
var file_agent_proto_depIdxs = []int32{
	0,  // 0: config_server.protov2.v2.ConfigInfo.status:type_name -> config_server.protov2.v2.ConfigStatus
	0,  // 1: config_server.protov2.v2.CommandInfo.status:type_name -> config_server.protov2.v2.ConfigStatus
	16, // 2: config_server.protov2.v2.AgentAttributes.extras:type_name -> config_server.protov2.v2.AgentAttributes.ExtrasEntry
	8,  // 3: config_server.protov2.v2.HeartbeatRequest.attributes:type_name -> config_server.protov2.v2.AgentAttributes
	5,  // 4: config_server.protov2.v2.HeartbeatRequest.tags:type_name -> config_server.protov2.v2.AgentGroupTag
	6,  // 5: config_server.protov2.v2.HeartbeatRequest.pipeline_configs:type_name -> config_server.protov2.v2.ConfigInfo
	6,  // 6: config_server.protov2.v2.HeartbeatRequest.instance_configs:type_name -> config_server.protov2.v2.ConfigInfo
	7,  // 7: config_server.protov2.v2.HeartbeatRequest.custom_commands:type_name -> config_server.protov2.v2.CommandInfo
	15, // 8: config_server.protov2.v2.HeartbeatResponse.commonResponse:type_name -> config_server.protov2.v2.CommonResponse
	10, // 9: config_server.protov2.v2.HeartbeatResponse.pipeline_config_updates:type_name -> config_server.protov2.v2.ConfigDetail
	10, // 10: config_server.protov2.v2.HeartbeatResponse.instance_config_updates:type_name -> config_server.protov2.v2.ConfigDetail
	11, // 11: config_server.protov2.v2.HeartbeatResponse.custom_command_updates:type_name -> config_server.protov2.v2.CommandDetail
	6,  // 12: config_server.protov2.v2.FetchConfigRequest.req_configs:type_name -> config_server.protov2.v2.ConfigInfo
	15, // 13: config_server.protov2.v2.FetchConfigResponse.commonResponse:type_name -> config_server.protov2.v2.CommonResponse
	10, // 14: config_server.protov2.v2.FetchConfigResponse.config_details:type_name -> config_server.protov2.v2.ConfigDetail
