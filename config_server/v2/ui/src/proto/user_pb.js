...
proto.GetConfigStatusListResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    requestId: msg.getRequestId_asB64(),
    commonResponse: (f = msg.getCommonResponse()) && agent_pb.CommonResponse.toObject(includeInstance, f),
    configStatusList: jspb.Message.toObjectList(msg.getConfigStatusList(),
 ...
 */
proto.GetConfigStatusListResponse.prototype.getConfigStatusList = function() {
  return /** @type{!Array<!proto.ConfigInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, agent_pb.ConfigInfo, 3));
};
 ...
 * @return {!proto.GetConfigStatusListResponse} returns this
*/
proto.GetConfigStatusListResponse.prototype.setConfigStatusList = function(value) {
 ...
 */
proto.GetConfigStatusListResponse.prototype.addConfigStatus = function(opt_value, opt_index) {
 ...
 * @return {!proto.GetConfigStatusListResponse} returns this
 */
proto.GetConfigStatusListResponse.prototype.clearConfigStatusList = function() {
  return this.setConfigStatusList([]);
};
