...
type AgentAttributes struct {
	...
	Ip         string            `protobuf:"bytes,3,opt,name=ip,proto3" json:"ip,omitempty"`                                                                                                   // Agent machine's ip
	Hostname   string            `protobuf:"bytes,4,opt,name=hostname,proto3" json:"hostname,omitempty"`                                                                                       // Agent machine's hostname
	Region     string            `protobuf:"bytes,5,opt,name=region,proto3" json:"region,omitempty"`                                                                                           // Agent machine's region
	Zone       string            `protobuf:"bytes,6,opt,name=zone,proto3" json:"zone,omitempty"`                                                                                               // Agent machine's zone
	AccountId  string            `protobuf:"bytes,7,opt,name=account_id,json=accountId,proto3" json:"account_id,omitempty"`                                                                    // Agent machine's account id
	Os         string            `protobuf:"bytes,8,opt,name=os,proto3" json:"os,omitempty"`                                                                                                   // Agent machine's os
	InstanceId string            `protobuf:"bytes,9,opt,name=instance_id,json=instanceId,proto3" json:"instance_id,omitempty"`                                                                 // Agent machine's instance id
...
func (x *AgentAttributes) GetAccountId() string {
	if x != nil {
		return x.AccountId
	}
	return ""
...
func (x *AgentAttributes) GetOs() string {
	if x != nil {
		return x.Os
	}
	return ""
...
func (x *AgentAttributes) GetInstanceId() string {
	if x != nil {
		return x.InstanceId
	}
	return ""
...
type HeartBeatRequest struct {
	...
	AgentSessionId  string           `protobuf:"bytes,11,opt,name=agent_session_id,json=agentSessionId,proto3" json:"agent_session_id,omitempty"` // Agent's session id
}
...
type MetadataRequest struct {
	...
	RequestId      string           `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	AgentId        string           `protobuf:"bytes,2,opt,name=agent_id,json=agentId,proto3" json:"agent_id,omitempty"`                        // Required, Agent's unique it will not be changed when restart
	AgentSessionId string           `protobuf:"bytes,3,opt,name=agent_session_id,json=agentSessionId,proto3" json:"agent_session_id,omitempty"` // Required, Agent's instance unique identification, it will be changed when restart
	...
	Attributes     *AgentAttributes `protobuf:"bytes,7,opt,name=attributes,proto3" json:"attributes,omitempty"`                                 // Agent's basic attributes
}
...
func (x *MetadataRequest) GetAttributes() *AgentAttributes {
	if x != nil {
		return x.Attributes
	}
	return nil
...
var file_agent_proto_rawDesc = []byte{
	...
	0xf3, 0x02, 0x0a, 0x0f, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75,
	...
	0x64, 0x12, 0x47, 0x0a, 0x06, 0x65, 0x78, 0x74, 0x72, 0x61, 0x73, 0x18, 0x64, 0x20, 0x03, 0x28,
	...
	0x66, 0x69, 0x67, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x22, 0x98, 0x02, 0x0a, 0x0f, 0x4d,
	...
	0x12, 0x43, 0x0a, 0x0a, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x73, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x41,
	0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x52, 0x0a, 0x61, 0x74, 0x74, 0x72, 0x69,
	0x62, 0x75, 0x74, 0x65, 0x73, 0x22, 0x7d, 0x0a, 0x10, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	...
	,
	...
	0x52, 0x52, 0x4f, 0x52, 0x10, 0x02, 0x42, 0x16, 0x5a, 0x14, 0x2e, 0x3b, 0x63, 0x6f, 0x6e, 0x66,
...
var file_agent_proto_depIdxs = []int32{
	...
	6,  // 20: configserver.proto.MetadataRequest.attributes:type_name -> configserver.proto.AgentAttributes
	2,  // 21: configserver.proto.MetadataResponse.code:type_name -> configserver.proto.RespCode
