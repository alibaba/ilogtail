...
plugin_main: clean
	...
	cp pkg/loongcollector/libPluginAdapter.so $(OUT_DIR)/libPluginAdapter.so
	cp pkg/loongcollector/PluginAdapter.dll $(OUT_DIR)/PluginAdapter.dll
...
unittest_plugin: clean import_plugins
	cp pkg/loongcollector/libPluginAdapter.so ./plugin_main
	cp pkg/loongcollector/PluginAdapter.dll ./plugin_main
...
unittest_pluginmanager: clean import_plugins
	cp pkg/loongcollector/libPluginAdapter.so ./plugin_main
	cp pkg/loongcollector/PluginAdapter.dll ./plugin_main
	cp pkg/loongcollector/libPluginAdapter.so ./pluginmanager
	mv ./plugins/input/prometheus/input_prometheus.go ./plugins/input/prometheus/input_prometheus.go.bak
