...
// OpenAccount invokes the sls_inner.OpenAccount API synchronously
// api document: https://help.aliyun.com/api/sls-inner/openaccount.html
...
// OpenAccountWithChan invokes the sls_inner.OpenAccount API asynchronously
// api document: https://help.aliyun.com/api/sls-inner/openaccount.html
...
// OpenAccountWithCallback invokes the sls_inner.OpenAccount API asynchronously
// api document: https://help.aliyun.com/api/sls-inner/openaccount.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateOpenAccountRequest() (request *OpenAccountRequest) {
	...
	request.InitWithApiInfo("Sls-inner", "2018-05-09", "OpenAccount", "", "")
	return
}
