...
// OrderSucceededCallback invokes the sls_inner.OrderSucceededCallback API synchronously
// api document: https://help.aliyun.com/api/sls-inner/ordersucceededcallback.html
...
// OrderSucceededCallbackWithChan invokes the sls_inner.OrderSucceededCallback API asynchronously
// api document: https://help.aliyun.com/api/sls-inner/ordersucceededcallback.html
...
// OrderSucceededCallbackWithCallback invokes the sls_inner.OrderSucceededCallback API asynchronously
// api document: https://help.aliyun.com/api/sls-inner/ordersucceededcallback.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateOrderSucceededCallbackRequest() (request *OrderSucceededCallbackRequest) {
	...
	request.InitWithApiInfo("Sls-inner", "2018-05-09", "OrderSucceededCallback", "", "")
	return
}
