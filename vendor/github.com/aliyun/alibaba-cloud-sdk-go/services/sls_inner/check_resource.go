...
// CheckResource invokes the sls_inner.CheckResource API synchronously
// api document: https://help.aliyun.com/api/sls-inner/checkresource.html
...
// CheckResourceWithChan invokes the sls_inner.CheckResource API asynchronously
// api document: https://help.aliyun.com/api/sls-inner/checkresource.html
...
// CheckResourceWithCallback invokes the sls_inner.CheckResource API asynchronously
// api document: https://help.aliyun.com/api/sls-inner/checkresource.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateCheckResourceRequest() (request *CheckResourceRequest) {
	...
	request.InitWithApiInfo("Sls-inner", "2018-05-09", "CheckResource", "", "")
	return
}
