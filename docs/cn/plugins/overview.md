...
| [`input_ebpf_file_observer`](input/input-ebpf-file-observer.md)<br> eBPF文件可观测数据                                      | SLS官方 | eBPF文件可观测数据采集。                                                 |
| [`input_ebpf_file_security`](input/input-ebpf-file-security.md)<br> eBPF文件安全数据                                      | SLS官方 | eBPF文件安全数据采集。                                                 |
| [`input_ebpf_network_observer`](input/input-ebpf-neywork-observer.md)<br> eBPF网络可观测数据                                      | SLS官方 | eBPF网络可观测数据采集。                                                 |
| [`input_ebpf_network_security`](input/input-ebpf-neywork-security.md)<br> eBPF网络安全数据                                      | SLS官方 | eBPF网络安全数据采集。                                                 |
| [`input_ebpf_process_observer`](input/input-ebpf-process-observer.md)<br> eBPF进程可观测数据                                      | SLS官方 | eBPF进程可观测数据采集。                                                 |
