...
const char* const MIN_VERSION = "min_version";
const char* const PROXY_URL = "proxy_url";
const char* const NO_PROXY = "no_proxy";
const char* const PROXY_FROM_ENVIRONMENT = "proxy_from_environment";
const char* const PROXY_CONNECT_HEADER = "proxy_connect_header";
