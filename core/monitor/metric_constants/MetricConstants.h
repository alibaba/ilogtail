...
extern const std::string METRIC_COMPONENT_QUEUE_FETCHED_ITEMS_TIMES_TOTAL;
extern const std::string METRIC_COMPONENT_QUEUE_FETCHED_ITEMS_TOTAL;
extern const std::string METRIC_COMPONENT_QUEUE_REJECTED_BY_REGION_LIMITER_TOTAL;
extern const std::string METRIC_COMPONENT_QUEUE_REJECTED_BY_PROJECT_LIMITER_TOTAL;
extern const std::string METRIC_COMPONENT_QUEUE_REJECTED_BY_LOGSTORE_LIMITER_TOTAL;
