...
void SourceManager::UpdateConfig(eBPFPluginType type, void* config) {
...
bool SourceManager::LoadAndStartDynamicLib(eBPFPluginType type, void* config) {
    ...
    case eBPFPluginType::SOCKETTRACE:{
      ...
      return StartSockettraceProbe(static_cast<SockettraceConfig*>(config));
      break;
    }
    case eBPFPluginType::PROCESS:{
      ...
      return StartProcessProbe(static_cast<SecureConfig*>(config));
      break;
    }
    default:
      break;
