...
static void BM_SimdJson(int size, int batchSize) {
    ...
    ProcessorParseSimdJsonNative& processor = *(new ProcessorParseSimdJsonNative);
    ...
    if (init) {
        ...
        std::cout << "simd json count: " << count << std::endl;
...
static void BM_SimdJsonOndemand(int size, int batchSize) {
    logtail::Logger::Instance().InitGlobalLoggers();
    ...
    ProcessorParseSimdOndemandJsonNative& processor = *(new ProcessorParseSimdOndemandJsonNative);
    ProcessorInstance processorInstance(&processor, getPluginMeta());
...
int main(int argc, char** argv) {
    ...
    BM_SimdJson(1000, 100);
    BM_RawJson(1000, 100);

    BM_SimdJsonOndemand(1000, 100);
