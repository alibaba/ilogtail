...
class TextParserSIMDUnittest : public testing::Test {
public:
...
void TextParserSIMDUnittest::TestParseMultipleLines() const {
    auto parser = TextParserSIMD();
...
UNIT_TEST_CASE(TextParserSIMDUnittest, TestParseMultipleLines)

void TextParserSIMDUnittest::TestParseMetricWithTagsAndTimestamp() const {
    auto parser = TextParserSIMD();
    string rawData = R"""(
...
UNIT_TEST_CASE(TextParserSIMDUnittest, TestParseMetricWithTagsAndTimestamp)

void TextParserSIMDUnittest::TestParseMetricWithManyTags() const {
    auto parser = TextParserSIMD();
    string rawData
...
UNIT_TEST_CASE(TextParserSIMDUnittest, TestParseMetricWithManyTags)

void TextParserSIMDUnittest::TestParseFaliure() {
    auto f = [](const std::string& content) {
        TextParserSIMD parser;
...
UNIT_TEST_CASE(TextParserSIMDUnittest, TestParseFaliure)

void TextParserSIMDUnittest::TestParseSuccess() {
    TextParserSIMD parser;
    string rawData;
    // single value
    rawData = "foobar 123";
...
UNIT_TEST_CASE(TextParserSIMDUnittest, TestParseSuccess)

void TextParserSIMDUnittest::TestHonorTimestamps() {
    // false
    TextParserSIMD parser(false);
    // has timestamp
...
UNIT_TEST_CASE(TextParserSIMDUnittest, TestHonorTimestamps)

void TextParserSIMDUnittest::TestParseUnicodeLabelValue() {
    auto parser = TextParserSIMD();
    string rawData
...
UNIT_TEST_CASE(TextParserSIMDUnittest, TestParseUnicodeLabelValue)
