...
void TextParserUnittest::TestSampleRegex() const {
    ...
    APSARA_TEST_TRUE(RE2::FullMatch(R"""(go_gc_duration_seconds{quantile="0"} 0)""",
                                    parser.mSampleRegex,
                                    RE2::Arg(&name),
                                    RE2::Arg(&labels),
                                    RE2::Arg(&unwrapped_labels),
                                    RE2::Arg(&value),
                                    RE2::Arg(&suffix),
                                    RE2::Arg(&timestamp)));
    ...
    APSARA_TEST_TRUE(RE2::FullMatch(R"""(go_memstats_mallocs_total 4859)""",
                                    parser.mSampleRegex,
                                    RE2::Arg(&name),
                                    RE2::Arg(&labels),
                                    RE2::Arg(&unwrapped_labels),
    ...
    APSARA_TEST_TRUE(RE2::FullMatch(R"""(go_memstats_other_sys_bytes 1.030122e+06)""",
                                    parser.mSampleRegex,
                                    RE2::Arg(&name),
                                    RE2::Arg(&labels),
                                    RE2::Arg(&unwrapped_labels),
    ...
    APSARA_TEST_TRUE(RE2::FullMatch(R"""(node_cpu_seconds_total{cpu="1",mode="idle"} 166606.17)""",
                                    parser.mSampleRegex,
                                    RE2::Arg(&name),
                                    RE2::Arg(&labels),
                                    RE2::Arg(&unwrapped_labels),
    ...
    APSARA_TEST_FALSE(RE2::FullMatch(R"""(node_cpu_seconds_total{cpu="1",mode="idle"} 166606.17        )""",
                                     parser.mSampleRegex,
                                     RE2::Arg(&name),
                                     RE2::Arg(&labels),
                                     RE2::Arg(&unwrapped_labels),
    ...
    APSARA_TEST_TRUE(RE2::FullMatch(
    ...
    APSARA_TEST_STREQ(
        R"""({container="",device="/dev/nvme0n1",id="/",image="",major="259",minor="0",name="",namespace="",operation="Async",pod=""})""",
        labels.data());
    APSARA_TEST_STREQ(
        R"""(container="",device="/dev/nvme0n1",id="/",image="",major="259",minor="0",name="",namespace="",operation="Async",pod="")""",
        unwrapped_labels.data());
    ...
    APSARA_TEST_FALSE(RE2::FullMatch(
        R"""(container_blkio_device_usage_total{container="",device="/dev/nvme0n1",id="/",image="",major="259",minor="0",name="",namespace="",operation="Async",pod=""} 9.9410452992e+10 1715829785083       )""",
        parser.mSampleRegex,
        RE2::Arg(&name),
        RE2::Arg(&labels),
