...
TEST(Cms_SlidingWindowTest, Test)
{
    ...
    EXPECT_EQ(0, slidingWindow.AccumulateCount());
    ...
    EXPECT_EQ(1, slidingWindow.AccumulateCount());
    ...
    EXPECT_EQ(2, slidingWindow.AccumulateCount());
    ...
    EXPECT_EQ(3, slidingWindow.AccumulateCount());
    ...
    EXPECT_EQ(4, slidingWindow.AccumulateCount());
    EXPECT_EQ(3, slidingWindow.Size());
