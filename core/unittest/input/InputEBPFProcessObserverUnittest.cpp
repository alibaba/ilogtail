...
void InputEBPFProcessObserverUnittest::OnSuccessfulStart() {
    unique_ptr<InputEBPFProcessObserver> input;
    Json::Value configJson, optionalGoPipeline;
    string configStr, errorMsg;
    uint32_t pluginIdx = 0;
...
void InputEBPFProcessObserverUnittest::OnSuccessfulStop() {
    unique_ptr<InputEBPFProcessObserver> input;
    Json::Value configJson, optionalGoPipeline;
    string configStr, errorMsg;
    uint32_t pluginIdx = 0;
...
UNIT_TEST_CASE(InputEBPFProcessObserverUnittest, OnSuccessfulStart)
UNIT_TEST_CASE(InputEBPFProcessObserverUnittest, OnSuccessfulStop)
