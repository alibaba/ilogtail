...
static void BM_SplRegex_20(benchmark::State& state) {
...
static void BM_SplRegex_2(benchmark::State& state) {
    logtail::Logger::Instance().InitGlobalLoggers();
...
static void BM_RawRegex_20(benchmark::State& state) {
    logtail::Logger::Instance().InitGlobalLoggers();
...
static void BM_RawRegex_2(benchmark::State& state) {
    logtail::Logger::Instance().InitGlobalLoggers();
...
BENCHMARK(BM_SplRegex_2)->MinTime(10);
BENCHMARK(BM_SplRegex_20)->MinTime(10);

BENCHMARK(BM_RawRegex_2)->MinTime(10);
BENCHMARK(BM_RawRegex_20)->MinTime(10);
